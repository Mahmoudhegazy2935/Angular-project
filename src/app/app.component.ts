...
@Component({
  ...
  standalone: true,
  // ,BrowserModule
  imports: [RouterModule,RouterOutlet, NavBarComponent, ProductsDetailsComponent, CartComponent,CommonModule,RouterModule,ProductsDetailsComponent,AllProductsComponent],
